  ...
  return (
    <div className="space-y-8 lg:space-y-12 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
        {/* Customer Value */}
        <div className="group relative bg-gradient-to-br from-rose-50/80 via-white/60 to-rose-100/80 backdrop-blur-sm border border-rose-200/40 rounded-2xl p-6 lg:p-8 hover:shadow-xl hover:shadow-rose-100/25 transition-all duration-500">
        ...
        {/* Business Value */}
        <div className="group relative bg-gradient-to-br from-sage-50/80 via-white/60 to-sage-100/80 backdrop-blur-sm border border-sage-200/40 rounded-2xl p-6 lg:p-8 hover:shadow-xl hover:shadow-sage-100/25 transition-all duration-500">
      ...
      <div className="space-y-8">
        <div className="flex flex-col sm:flex-row gap-4 lg:gap-6">
          <Link to="/signup/customer" className="group flex-1">
            <Button className="w-full h-auto p-6 lg:p-8 bg-gradient-to-br from-rose-100 via-rose-200 to-rose-300 hover:from-rose-200 hover:via-rose-300 hover:to-rose-400 text-rose-800 border-0 rounded-2xl transition-all duration-500 hover:shadow-2xl hover:shadow-rose-200/30 hover:-translate-y-2 group-hover:scale-[1.02]">
          ...
          <Link to="/signup/business" className="group flex-1">
            <Button className="w-full h-auto p-6 lg:p-8 bg-gradient-to-br from-sage-100 via-sage-200 to-sage-300 hover:from-sage-200 hover:via-sage-300 hover:to-sage-400 text-sage-800 border-0 rounded-2xl transition-all duration-500 hover:shadow-2xl hover:shadow-sage-200/30 hover:-translate-y-2 group-hover:scale-[1.02]">
              <div className="flex flex-col items-center text-center space-y-3">
        ...
        {/* Trust Badges */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-6 lg:gap-12 py-6">
          {[
