...
const CustomerSignup = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    // Rate limiting check
    if (!rateLimitCheck('signup', 3, 10 * 60 * 1000)) {
      toast({
            ...
            <Card className="bg-white/60 backdrop-blur-sm shadow-elegant p-8 rounded-2xl border border-rose-100/50">
              <div className="text-center space-y-4">
                ...
                <p className="text-sm text-muted-foreground">
                  We've sent a verification email to <strong className="text-rose-600">{email}</strong>. 
                  Please click the link in the email to verify your account before logging in.
                </p>
                <Button
                  onClick={() => navigate('/auth')}
                  className="w-full mt-6 bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white rounded-xl h-12 font-semibold"
                >
                  Go to Login
                </Button>
              </div>
        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="mb-8 text-center">
            <div className="inline-flex items-center bg-rose-50 border border-rose-200 rounded-full px-4 py-2 text-sm text-rose-700">
              <span className="w-6 h-6 bg-rose-600 text-white rounded-full flex items-center justify-center text-xs font-semibold mr-3">1</span>
          ...
          <Card className="bg-white/60 backdrop-blur-sm shadow-elegant rounded-2xl border border-rose-100/50 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 overflow-hidden">
            <div className="p-8 lg:p-12">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <User className="absolute left-4 top-4 h-5 w-5 text-rose-400 z-10" />
                        <Input
                          id="full-name"
                          type="text"
                          ...
                          className="pl-12 pr-12 h-14 rounded-2xl border-rose-200 focus:border-rose-500 focus:ring-rose-200 text-base"
                          required
                        />
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <Mail className="absolute left-4 top-4 h-5 w-5 text-rose-400 z-10" />
                        <Input
                          id="email"
                          type="email"
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <Phone className="absolute left-4 top-4 h-5 w-5 text-rose-400 z-10" />
                        <Input
                          id="phone"
                          type="tel"
                    ...
                    <div className="space-y-3">
                      ...
                      <PostcodeLookup
                        ...
                        className="h-14 rounded-2xl border-rose-200 focus:border-rose-500 focus:ring-rose-200 text-base"
                        showCoverageRadius={false}
                      />
                      <p className="text-sm text-muted-foreground">
                        We'll connect you with local services in your area
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <Lock className="absolute left-4 top-4 h-5 w-5 text-rose-400 z-10" />
                        <Input
                          id="password"
                        ...
                        <button
                          ...
                          className="absolute right-4 top-4 text-rose-400 hover:text-rose-600 transition-colors"
                        >
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-xs text-muted-foreground">
                            Password strength: {
                              ...
                              : getPasswordStrength() <= 3 ? 'Fair'
                              : getPasswordStrength() <= 4 ? 'Good'
                              : 'Strong'
                            }
                          </p>
                        </div>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="relative">
                        <CheckCircle className="absolute left-4 top-4 h-5 w-5 text-rose-400 z-10" />
                        <Input
                          id="confirm-password"
                          type={showPassword ? "text" : "password"}
                ...
                {/* Terms & Conditions */}
                <div className="bg-rose-50/50 rounded-xl p-6 space-y-4">
                  <p className="text-sm text-muted-foreground">
                    By creating an account, you agree to our{' '}
                    <Link to="/terms" className="text-rose-600 hover:text-rose-700 underline">
                      Terms of Service
                    </Link>{' '}
                    and{' '}
                    <Link to="/privacy" className="text-rose-600 hover:text-rose-700 underline">
                      Privacy Policy
                    </Link>
                  </p>
                </div>
                ...
                <Button
                  type="submit"
                  disabled={loading}
                  className="w-full h-14 text-lg font-semibold rounded-2xl bg-gradient-to-r from-rose-600 to-rose-700 hover:from-rose-700 hover:to-rose-800 text-white shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  {loading ? (
                ...
                <p className="text-center text-sm text-muted-foreground">
                  ...
                  <Link to="/auth" className="text-rose-600 hover:text-rose-700 font-medium">
                    Sign in here
                  </Link>
                </p>
              </form>
