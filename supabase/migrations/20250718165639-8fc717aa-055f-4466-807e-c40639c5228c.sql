...
-- Add current_role column to profiles table
ALTER TABLE public.profiles 
ADD COLUMN current_role user_role;
...
-- Update current_role to match the existing role
UPDATE public.profiles 
SET current_role = role;

-- Make current_role NOT NULL after setting values
ALTER TABLE public.profiles 
...
AS $function$
BEGIN
  INSERT INTO public.profiles (user_id, email, role, current_role, name, phone, location)
  VALUES (
    new.id, 
    new.email, 
